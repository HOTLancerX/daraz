 ...
 *
 * Daraz-style product card — clean white card with prominent badge,
 * image, title, star rating hint, price stack and Add to Cart button.
 */
...
export default function DarazBox1({ data, productUrl, currencySymbol = '$' }: DarazBoxProps) {
    ...
    return (
        <div className="group relative bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-lg transition-shadow overflow-hidden flex flex-col">
            ...
            <Link href={productUrl} className="block bg-gray-50 overflow-hidden" style={{ aspectRatio: '1/1' }}>
                {img ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center text-gray-200">
                        <Icon icon="mdi:image-off" width="40" height="40" />
                    </div>
                )}
            </Link>
            ...
            <div className="flex flex-col flex-1 p-3 gap-1.5">
                ...
                >
                    <Icon icon="mdi:cart-plus" width="13" height="13" />
